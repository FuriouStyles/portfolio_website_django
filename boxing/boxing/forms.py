...
class PredictBoutURL(forms.Form):
    MINIMUM = 'minimum'
...
class PredictBout(forms.Form):
    ...
    # Need to break division into a single item
    ...
    red_years_active = forms.CharField(label='Red Corner Years Active at Fight Time')
    ...
    blue_years_active = forms.CharField(label='Blue Corner Years Active At Fight Time')
